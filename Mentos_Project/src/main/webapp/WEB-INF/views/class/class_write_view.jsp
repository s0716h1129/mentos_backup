...
<div class="container">
	...
	<input type="hidden" id="class_location" name="class_location">
	<input type="hidden" id="class_location_x" name="class_location_x">
	<input type="hidden" id="class_location_y" name="class_location_y">
