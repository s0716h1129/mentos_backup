...
public class ClassController {
	...
	public String searchClass(HttpServletRequest request,HttpSession session, Model model, @ModelAttribute("bPageInfo") BPageInfo bPageInfo) {
		...
		//model로 두가지 보낼 수 있다.
		model.addAttribute("list", dao.searchClass(nEnd, nStart, search, location, category));
		model.addAttribute("page", pinfo);		
