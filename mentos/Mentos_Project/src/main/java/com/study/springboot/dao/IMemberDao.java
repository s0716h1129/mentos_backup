...
public interface IMemberDao {
   ...
   public List<HistoryDto> history_list(int nStart, int nEnd, String id);
    ...
    //안드로이드
 	public int AndinsertMember(String email,String pw,String nickname,String phoneNumber,String image); // 회원가입
 	public String loginName(String email); // 안드로이드 로그인이메일에 따른 이름값 출력
 }
