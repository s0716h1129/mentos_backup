...
<form id="fileUp" action="rentDao" method="post" name="rental">
	...
	<div class="form-group">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<input type="text" name="place" id="sample5_address" placeholder="주소" class="form-control" readonly="readonly">
				<input type="text" name="place_place" id="detail_address" placeholder="나머지 주소" class="form-control">
	...
	<div class="form-group col-md-12">
		...
		<input type="text" name="place_people_num"  class="form-control"> 
	</div>
	
		<div class="form-group col-md-12">
		<label for="inputAddress2">대여료</label>
		<input type="text" name="place_price"  class="form-control"> 
	</div>
	
	<div class="form-group col-md-12">
		<label for="inputAddress2">장소정보</label>
		<textarea id="summernote" name="place_content" class="form-control" placeholder="content"></textarea> 
		<script>	
