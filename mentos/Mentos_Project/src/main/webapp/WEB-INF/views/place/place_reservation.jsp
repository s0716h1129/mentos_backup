...
<form action="reservation">	
	...
	<div class="form-group col-md-8">
		<label>문의내용</label><br>
		<textarea name="" rows="10" cols="106"></textarea>
	</div>
	<div class="form-group col-md-8">
		<label>서비스동의</label><br>
		<textarea rows="10" cols="106">
제 1 조 목적 및 정의
...
카카오 서비스: 카카오톡, 카카오스토리 등 회사가 kakao(카카오) 브랜드를 사용하여 제공하는 모든 서비스 (단, 서비스 명칭에 ‘카카오’가 사용되더라도 회사가 아닌 카카오 계열사에서 제공하는 서비스 (예: 카카오 T택시 서비스)는 본 약관의 카카오 서비스에 포함되지 않습니다)
...
본 약관 또는 통합서비스는 대한민국법령에 의하여 규정되고 이행됩니다. 통합서비스 이용과 관련하여 회사와 여러분 간에 분쟁이 발생하면 이의 해결을 위해 성실히 협의할 것입니다. 그럼에도 불구하고 해결되지 않으면 민사소송법의 관할법원에 소를 제기할 수 있습니다.
		...
		<input type="checkbox" name="chk" style="width:20px;height:20px;"> &nbsp;&nbsp;약간의 동의
	</div>
	
	<div class="form-group col-md-8">
	<a href="" class="btn btn-primary btn-lg active" role="button">등록</a>
	</div>
</form>	
</div>
</body>
